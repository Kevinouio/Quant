...
const sectionContent: ChapterSectionContent[] = [
  {
    "title": "Introduction",
    "paragraphs": [
      "I'm an undergraduate studing Mathematics and Computer Science. 'You might be wondering, Hey is this guy a quant or a wanna be quant or something?' or 'This guy must be very smart or something.' Well I'll tell you what, I'm just a wanna be who just wants to learn about finance. I personally have no idea about anything about finance when it comes to investing, trading, or even quantatative finance. "
    ]
  },
  {
  ...
  },
  {
    ...
    "paragraphs": [
      "The best way to contact me is by email or through my personal website: kevinouio.com.",
      "If you see errors or think something should be improved, please open an issue or submit a pull request on GitHub."
    ]
  },
  {
  ...
  },
  {
    ...
    "paragraphs": [
      "I am grateful to my friends for pushing me to stay productive and keep building things that matter to me.",
      "I hope this project encourages you to build your own long-form learning project too.",
      "With that said, welcome to my first textbook-style project on finance through the lens of math and computer science."
    ]
  }
];
