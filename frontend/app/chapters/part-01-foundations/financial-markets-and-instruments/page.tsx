...
const sectionContent: ChapterSectionContent[] = [
  {
    ...
    "blocks": [
      ...
      {
        "type": "paragraph",
        "text": "In economics and finance, the word **market** refers to any arrangement in which buyers and sellers come together to exchange goods, services, or financial assets. A market doesn't need to be a physical location as it can represent many different things. It could represent a store, a stock exchange, a website, or even an information system of trade between individuals or companies. What makes something a market just depends on the interaction between supply and demand of a given asset."
      },
      {
        "type": "paragraph",
      ...
      {
        "type": "paragraph",
        "text": "The price of a given good isn't given arbitrarily. In markets that are more dependent on the individuals, it more depends on the interactions between how much buyers are willing to pay and how much sellers are willing to accept. This general process is known as price discovery."
      },
      {
        "type": "paragraph",
      ...
      {
        "type": "paragraph",
        "text": "In *financial markets*, this can be influenced by:"
      },
      {
        "type": "unorderedList",
        "items": [
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "paragraph",
        "text": "A **common stock** is the standard form of corporate ownership. Shareholders typically have:"
      },
      {
        "type": "paragraph",
        "text": "-voting rights in corporate matters, -a claim on company profits through dividends if dividends are declared, -the potential to benefit from appreciation in the company’s share price."
      },
      {
        "type": "paragraph",
      ...
      {
        "type": "paragraph",
        "text": "A **preferred stock** generally provides shareholders with priority over common shareholders in receiving dividends and in liquidation. In many cases, preferred stock pays a fixed dividend, making it resemble a hybrid between stock and debt."
      },
      {
        "type": "paragraph",
